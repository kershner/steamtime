...
# Grabs SteamID from form, generates data by passing it to relevant functions
def get_results_data():
    ...
    if request.method == 'POST':
        ...
        if not form.validate():
            ...
            two_weeks_stats_pages = get_two_weeks_stats_page(two_weeks[0], steam_id, two_weeks)
            append_2weeks_stat_pages(two_weeks_stats_pages, two_weeks)
